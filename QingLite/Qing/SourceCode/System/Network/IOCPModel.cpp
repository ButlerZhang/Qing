...
void ReleaseSocket(SOCKET &Socket)
{
    if (Socket != INVALID_SOCKET)
    {
        ...
        BoostLog::WriteInfo(BoostFormat(L"Release Socket = %I64d.", Socket));
...
std::shared_ptr<IOCPContext> IOCPSocketContext::GetNewIOContext(unsigned __int64 ID)
{
    ...
    BoostLog::WriteInfo(BoostFormat(L"Push new IOCPContext, Socket = %I64d, IOCPContextID = %I64d.",
...
bool IOCPSocketContext::DeleteContext(const IOCPContext &RemoveIOContext)
{
    ...
    BoostLog::WriteInfo(BoostFormat(L"Delete IOCPContext %s, Socket = %I64d, IOCPContextID = %I64d.",
